...
ways=wayj[:-len("\src\main\java\org\example\backend\machinelearn\way2.py")]
for i in range(1,9):
...
result.to_excel(excel_writer="result2.xls",index=False,encoding='utf-8')
